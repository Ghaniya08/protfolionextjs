        ...
        <section  className="flex md:ml-72 h-44 ">
            <form onSubmit={onSubmit} >
                ...
                <div className="mt-4">
                    ...
                    <input className="md:w-[650px]  h-8 bg-transparent border-2 bg-blue-200 p-6 border-solid border-blue-300 outline-none rounded-lg  text-lg ml-2 text-blue-800 " type="text" placeholder="Enter Your Name " name="Name" required />
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea className="h-52 md:w-[650px] mt-3 bg-blue-200 bg-transparent border-2 border-solid border-blue-300 outline-none rounded-lg p-6 text-lg ml-2 text-blue-800" name="Message" id=""  placeholder="Enter Your Message " required ></textarea>
                </div>
...
export default Contact;
        ...
        // "max-w-[600px] w-96 bg-blue-300 h-56  justify-between p-6 rounded-md shadow-[0_0_10px_rgba(0,0,0,1)] m-5