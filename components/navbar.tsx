...
//           <h1 className="font-bold text-xl">ＧＨＡＮＩＹＡ ＫＨＡＮ</h1>
//           <button
...
//             <a href="#header" className="text-white text-xl hover:underline block m-6">𝐇𝐨𝐦𝐞</a>
//             <a href="#About" className="text-white text-xl hover:underline block m-6">𝐀𝐛𝐨𝐮𝐭</a>
//             <a href="#Service" className="text-white text-xl hover:underline block m-6">𝐒𝐞𝐫𝐯𝐢𝐜𝐞𝐬</a>
//             <a href="#Contact" className="text-white text-xl hover:underline block m-6">𝐂𝐨𝐧𝐭𝐚𝐜𝐭</a>
//           </div>
//         </div>
//       </nav>
//     </div>
